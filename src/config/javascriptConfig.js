import { OBJECT_FOR_IN } from "/src/config/commonConfig";
...
// Note: this is lexically scoped in arrow function, i.e. arrow function uses this of the parent and do not create its own execution context`,
      ...
      },
      {
        ...
        list: [
          "<b>event.target</b> – the deepest element that originated the event.",
          "<b>event.currentTarget (=this)</b> – the current element that handles the event (the one that has the handler on it)",
          "<b>event.eventPhase</b> – the current phase (capturing=1, target=2, bubbling=3).",
        ],
        code: null,
        note: null,
      },
      {
        ...
        list: ["Bubbling - bottom to top", "Capturing - top to bottom"],
        code: [
          {
            title: "Example",
            code: `<body onload="onLoadFunction()">
  ...
  <div id="parent">
    ...
    <div id="other">
      Other
          ...
          {
            title: "JS File",
            code: `var onLoadFunction = function() {
  ...
  */
  ...
  c.addEventListener('click', function() {
    console.log('clild clicked');
        ...
        note: "<b>Stop Bubbling - </b> event.stopPropagation() ",
      },
      {
        title: "Symbol",
        keywords: "Symbol",
...
iterator.next()    // { value: undefined, done: true}`,
          ...
          {
            title: "Infine maker using generators",
            code: `function *infiniteMaker() {
  let i=1;
...
localStorage.clear();`,
      ...
      },
      {
        ...
        description: "",
        list: [
          "<b>Normal Script</b>: HTML parsing is going on, it encounters script tag, it stops HTML parsing, fetches the script, execute the script, then again start doing HTML parsing ",
          "HTML parsing -> Fetches script -> Execute script -> HTML parsing",
        ...
        table: [
          {
            columns: [
              ...
              { field: "example", headerName: "Example", width: 300 },
        ...
        table: [
          {
            columns: [
                ...
                { field: "example", headerName: "Example", width: 130 },
    ...
    children: [
      {
        ...
        list: [
          ...
          "Creational pattern, Structual pattern, Behavioral pattern",
        ],
        code: null,
        note: null,
      },
      {
        ...
        list: [
          "Creational Category",
          "<b>Dynamic object creation</b>: It can be used in cases where the type of the object is decided at runtime.",
          "<b>Abstraction</b>: The user never really has to access the actual object’s constructor.",
          "<b>Reusability/Maintenance</b>: Same factories can be used for similar objects and it allows us to add/remove new object classes easily without changing a lot of code.",
        ],
        code: [
          {
            title: "",
